...
Para \(n\equiv0\pmod4\), las tríadas perfectas se organizan en órbitas bajo la acción del grupo simétrico \(S_n\), clasificadas por el tamaño de la triple intersección de sus átomos de Venn.
...
- las órbitas están determinadas por el invariante
...
- ✔ Clasificación general por órbitas de \(S_n\).
...
La aportación consiste en mostrar cómo todos ellos emergen de una misma construcción discreta basada en equilibrio y ortogonalidad, y en desarrollar una formulación general mediante órbitas de \(S_n\), dualidad por complemento y estructuras relacionales.
