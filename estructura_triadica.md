...
**Completitud.** Si dos tríadas \((A,B,C)\) y \((A',B',C')\) tienen el mismo \(t\), sus 8 átomos de Venn tienen exactamente los mismos tamaños \((t,m-t,m-t,m-t,t,t,t,m-t)\). Como \(S_n\) actúa libremente sobre \([n]\), existe una permutación que envía cada átomo de la primera tríada al átomo correspondiente de la segunda. Verificado constructivamente para \(n=8\) (45360 pares) y \(n=12\) (2000 pares con \(\sigma\) explícita).
